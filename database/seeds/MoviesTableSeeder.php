...
class MoviesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Movie::insert([
                ...
                'cover' => 'http://imgur.com/sRdILsh',
                'actor' => 'Meg Ryan Billy Crystal',
                'genre' => 'Comedy Drama Romance',
                'description' => 'The film chronicles this dilemma through the eleven year relationship between Harry and Sally who meet in college, then pursue their own lives until they reconnect ten years later.',
